  ...
  return (
    <section id="about" className="py-20 bg-gray-100 text-gray-800">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-lg leading-7 mb-6">
          Over the past year, I have worked on various projects, including a food ordering website, a job portal, and an Instagram-like social media platform. My work emphasizes clean code, responsive design, and optimized performance.
        </p>
        <p className="text-lg leading-7 mb-6">
